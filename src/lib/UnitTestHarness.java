/**
    This class provides a framework to more easily run unit
    tests on your classes.

    It aims to reduce some of the boiler plate code I've
    written to test classes previously.

    I'm sure it's similar to JUnit.
*/
